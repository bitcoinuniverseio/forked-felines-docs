...
Official documentation for **Forked Felines**: the KNOT HEADS companion collection of up to 3,333 hand-drawn felines, each one inscribed whole on Bitcoin.

New here? Three pages answer almost everything:

1. [What is Forked Felines?](start-here/what-is-forked-felines.md)
2. [Mint in 3 steps](start-here/mint-in-3-steps.md)
3. [Official product facts](reference/official-product-facts.md)

## Start here

- [What is Forked Felines?](start-here/what-is-forked-felines.md)
- [Explain it in 30 seconds](start-here/explain-it-in-30-seconds.md)
- [Mint in 3 steps](start-here/mint-in-3-steps.md)
- [Knot Heads holder start](start-here/knot-heads-holder-start.md)
- [Public minter start](start-here/public-minter-start.md)

## Collectors

- [Supported wallets](collectors/supported-wallets.md)
- [Receiving vs payment address](collectors/receiving-vs-payment-address.md)
- [Prices and fees](collectors/prices-and-fees.md)
...
- [What we will never ask](safety/what-we-will-never-ask.md)
- [Privacy](safety/privacy.md)
- [Reporting a security problem](safety/reporting-a-security-problem.md)

## Help

- [Troubleshooting](help/troubleshooting.md)
- [Payment and confirmation](help/payment-and-confirmation.md)
...
*Financial facts are never jokes here. Everything else is fair game.*
