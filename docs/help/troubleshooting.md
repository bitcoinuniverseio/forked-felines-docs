...
| An item says ON HOLD FOR REVIEW | That Feline's fulfillment is paused for staff; the parent order and other items have separate states | Do not pay again. Use Contact support on the ticket for an update on the existing order |
| Payment confirmation says unavailable | The house cannot currently establish the payment's chain confirmation | Do not treat this as a request to pay again. Keep the original ticket and transaction reference |
